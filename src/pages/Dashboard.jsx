            ...
            <div className="max-w-7xl mx-auto px-4 relative">
              {projects.length === 0 ? (
                  ...
                  <>
                      ...
                      {visibleProjects.map((project) => {
                        ...
                        return (
                            <div
                                ...
                                style={{ minHeight: '480px' }} // Фиксированная минимальная высота для стабильности
                            >
                              {project.image && (
                              ...
                              <div className="mb-4"> {/* Обернули статус в контейнер с фиксированной высотой */}
                                <span
                              ...
                              {project.steps?.length > 0 && (
                                  <div className="mb-4"> {/* Контейнер для Timeline */}
                                    <Timeline steps={project.steps} />
                                  </div>
                              )}

                              {/* Progress bar - фиксированная позиция перед кнопками */}
                              <div className="mb-4" style={{ minHeight: '20px' }}> {/* Фиксированная минимальная высота */}
                    ...
                    {/* Slider arrows - как были изначально */}
                    {projects.length > 3 && (
                        <>
                          <button
                              onClick={prevSlide}
