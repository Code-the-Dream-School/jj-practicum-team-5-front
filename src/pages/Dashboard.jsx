                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center relative">
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                            Event Projects
                            <span className="block text-blue-700 text-3xl md:text-4xl mt-2">Dashboard</span>
                        </h1>
            ...
            <section className="py-6 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <div className="inline-flex items-center px-8 py-4 rounded-2xl bg-white border-2 border-blue-400 shadow-md">
                            <span className="text-gray-800 font-semibold text-lg">Total Projects:</span>
                            <span className="ml-3 text-blue-700 font-bold text-xl">{projects.length}</span>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {visibleProjects.map((project) => (
                                    ...
                                    >
                                        ...
                                        <div className={`flex flex-col flex-1 ${project.image ? "mt-4" : ""}`}>
        <span
            className={`px-4 py-2 rounded-full text-xs font-semibold ${getStatusColor(project.status)}`}
        >
            {project.status}
        </span>
