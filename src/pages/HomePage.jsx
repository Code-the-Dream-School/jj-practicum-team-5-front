...
export default function HomePage() {
  return (
    <div className="h-screen" style={{ backgroundColor: "#ABD4F6" }}>
      {/* Hero section with custom mixed background */}
      <section className="relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Manage Projects
              <span className="block" style={{ color: "#008096" }}>
                Efficiently
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {/* Registration button gradient #96007E → #809600 */}
              <Link
                to="/signup"
      ...
      <section className="py-6 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 rounded-2xl bg-gray-50 hover:bg-gray-100 transition-all duration-200 shadow-md">
              <div
              ...
              <p className="text-gray-600 leading-relaxed">
                Create, assign and track tasks with a convenient interface and
            ...
            <div className="text-center p-8 rounded-2xl bg-gray-50 hover:bg-gray-100 transition-all duration-200 shadow-md">
              ...
              <p className="text-gray-600 leading-relaxed">
                Unite teams, share files and communicate in real-time to achieve
                common goals
              </p>
            </div>
