              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Unite teams and share files seamlessly",
                  },
                  {
                    icon: "📊",
                    bg: "#5A004C",
                    title: "Project Planning",
                    text: "Plan timelines and monitor progress",
                  },
                ].map((f, i) => (
                  <div
                    key={i}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  {[
                    {
                      icon: "✨",
                      title: "Easy to Use",
                      text: "No lengthy training required - start immediately",
                    },
                    {
                      icon: "⚙️",
                      title: "Flexible Configuration",
                      text: "Adapt the system to your unique needs",
                    },
                    {
                      icon: "📈",
                      title: "Real-time Analytics",
                      text: "Get up-to-date project progress insights",
                    },
                    {
                      icon: "🔒",
                      title: "Data Security",
                      text: "Enterprise-grade protection and backup",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-start space-x-4 p-6 bg-white bg-opacity-90 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                    >
              ...
              <div className="bg-white bg-opacity-95 border border-gray-200 rounded-2xl shadow-xl p-8">
                <div className="text-center space-y-8">
                  <div>
                    <div className="text-4xl sm:text-3xl font-bold text-[#B40098] mb-2">
                      95%
                    </div>
